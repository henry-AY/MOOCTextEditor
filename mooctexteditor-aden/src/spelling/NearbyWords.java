...
//		TrieNode curr = new TrieNode();
		List<String> stringsOneMutationAway;
		...
		while(!queue.isEmpty() && retList.size() < numSuggestions) {
			stringsOneMutationAway = distanceOne(((LinkedList<String>) queue).poll(), true);
			queue.addAll(stringsOneMutationAway);
//			for(int i = 0; i < stringsOneMutationAway.size(); i++) {
//				queue.add(stringsOneMutationAway);
//			}
			for(String n : stringsOneMutationAway) {
